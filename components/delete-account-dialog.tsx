...
/**
 * Confirmation dialog for permanent account / workspace deletion.
 * Requires the user to type their email address to enable the action.
 */
export function DeleteAccountDialog({
  ...
  async function onConfirm() {
    ...
    try {
      ...
      setOpen(false);
      // After deletion, send the user to the homepage. Clerk session
      // remains valid until the user signs out separately.
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => (setOpen(v), setConfirm(""), setError(null))}>
