...
interface EmptyStateProps {
  ...
  onAction?: () => void;
  className?: string;
  /** Optional secondary action (rare). */
  secondaryLabel?: string;
  secondaryHref?: string;
}

/**
 * Reusable empty-state card. Used by dashboard pages when there is no data
 * to show (e.g. no posts, no media, no automation rules).
 */
