...
/**
 * Top-of-page banner that appears on every legal page.
 * Reminds reviewers (and the public) that the policy is a draft
 * pending professional legal review. Required by the audit.
 */
